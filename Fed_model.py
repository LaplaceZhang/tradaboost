# -*- coding: UTF-8 -*-
# Source code comes from [Github](https://github.com/chenchiwei/tradaboost/blob/master/TrAdaboost.py)
# We plan to make it works under federated learning framework
...
class TrAdaBoost():
    ...
    def tradaboost(self, trans_S, trans_A, label_S, label_A, test, N):
